...
Plans:
- [ ] 01-01-PLAN.md — Backend infrastructure: Python project, DeepAgents agent stubs, graph.json, start_server.py
- [ ] 01-02-PLAN.md — Frontend shell: Next.js 15 project, layout, theme, resizable panels, providers
