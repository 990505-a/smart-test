...
async def memory_status(user: CurrentUserDep, space: str = Query(default="default")):
...
async def list_modules(user: CurrentUserDep, space: str = Query(default="default")):
...
async def create_module(data: ModuleCreateRequest, user: CurrentUserDep,
                        space: str = Query(default="default")):
